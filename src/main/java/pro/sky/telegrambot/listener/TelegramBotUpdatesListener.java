...
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    public int process(List<Update> updates) {
        updates.forEach(update -> {
            ...
            String initialText = "Hi! " +
                    "To plan a task, send it in the format:\n*01.01.2022 20:00 Do your homework*";
            ...
            if ("/start".equals(text)) {
                ...
                if (matcher.matches() && (dateTime = parse(matcher.group(1))) != null) {
                    ...
                    sendHelper.sendMessage(chatId, "The task is scheduled!");
                } else {
                    sendHelper.sendMessage(chatId, "Incorrect message format!");
                }
            }
        });
